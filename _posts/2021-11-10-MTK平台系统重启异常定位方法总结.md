...
<li>2.Android Dropbox</li>
</ul>
<h1 id="kernel-exception">三、Kernel Exception类重启问题快速分析</h1>
...
<h1 id="watchdog-timeout">四、Watchdog Timeout类重启问题快速分析</h1>
<p>看门狗超时有两种</p>
<ul>
...
<h1 id="hardware-reboot">五、Hardware Reboot类重启问题快速分析</h1>
