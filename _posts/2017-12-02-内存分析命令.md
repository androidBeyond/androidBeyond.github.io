...
<!-- <img src="/images/about-me/gityuan_weixin_logo.png" alt="gityuan">-->
                ...
                <ul class="pager">
                    ...
                    <li class="previous">
                        <a target="_blank" href="/2016/01/01/handler-message-usage/" data-toggle="tooltip" data-placement="top" title="Android消息机制3-Handler(实战)">
                        上一篇<br>
                    ...
                    <li class="next">
                        <a target="_blank" href="/2016/01/03/java-thread-wait-sleep/" data-toggle="tooltip" data-placement="top" title="wait、notify、sleep、interrupt对比分析">
                        下一篇<br>
                        <span>wait、notify、sleep、interrupt对比分析</span>
                        </a>
                    </li>
