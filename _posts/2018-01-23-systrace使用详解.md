...
<p>一、Systrace 简介<br>
二、Systrace  使用方法<br>
三、使用命令行抓取 Systrace<br>
四、使用Systrace 检测UI 性能<br>
五、使用Systrace 检测警告以及掉帧问题<br>
六、查看trace 文件的快捷键<br>
七、代码中添加trace 标记具体分析问题所在<br>
八、使用TraceView 分析trace Log</p>
</blockquote>
<h1>一、Systrace 简介</h1>
...
<div class="image-view" data-width="709" data-height="368"><img data-original-src="//upload-images.jianshu.io/upload_images/5851256-4d28e0ab1cf0ddca.png" data-original-width="709" data-original-height="368" data-original-format="" data-original-filesize="52144"></div>
</div>
