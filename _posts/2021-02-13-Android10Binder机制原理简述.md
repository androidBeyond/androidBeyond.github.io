...
<h2 id="一概述">一、概述</h2>
<h3 id="1-1-Binder架构"><a href="#1-1-Binder架构" class="headerlink" title="1.1 Binder架构"></a>1.1 Binder架构</h3><p>Android内核基于Linux系统，而Linux系统进程间通信方式有很多，如管道，共享内存，信号，信号量，消息队列，套接字。而Android为什么要用binder进行进程间的通信，主要是从以下几个方面考虑的。</p>
